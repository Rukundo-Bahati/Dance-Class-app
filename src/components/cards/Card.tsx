...
const Card = ({ header, content, img }: Props) => {
  return (
    <div className="w-full sm:max-w-xs bg-white border border-gray-200 rounded-lg shadow m-9 dark:bg-gray-800 dark:border-gray-700 hover:shadow-md hover:shadow-emerald-400 duration-200 ">
      <a href="#">

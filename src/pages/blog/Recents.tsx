    ...
    <div className="flex flex-wrap gap-4 p-4 bg-white">
      ...
      <div className="flex-1 min-w-[300px] flex flex-col items-center">
        ...
        <div className="bg-gray-200 w-full rounded-lg p-10 ">
          <h2 className="text-3xl m-3">Recent Posts</h2>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center justify-center">
              <img
                src="src/assets/p3.webp"
                alt=""
                className="w-24 h-24 rounded-full"
              />
              <div className="flex flex-col">
                <h2 className="text-xl font-semibold">
                  Community Centers, Gyms Or Cultural
                </h2>
                <div className="flex items-center">
                  <FaCalendar className="text-red-600 mr-1" />
                  <p className="text-gray-600">Septermber 10, 2024</p>
                </div>
              </div>
            </div>
            <div className="flex items-center justify-center">
              <img
                src="src/assets/p4.webp"
                alt=""
                className="w-24 h-24 rounded-full"
              />
              <div className="flex flex-col">
